...
output_mask = readfits(params.main.root_dir+'pupilstop/'+params.pupil_stop_down.pupil_mask_tag+'.fits', ext=1)
...
; up-ward
prop_up_1055.isUpwards = 1B
;prop_up_1055.mask = output_mask
...
; idea Roberto - use the TT commands from tt_dm for correcting uplink - TT from LGS
...
ef_prod_sat.in_ef2 = dm_ngs.out_layer
...
psf_ngs_ref = calc_psf(phase, congrid(pupstop_down.A,params.main.pixel_pupil,params.main.pixel_pupil), imwidth=spsf, normalize=1B, nocenter=1B, GPU=0B)
