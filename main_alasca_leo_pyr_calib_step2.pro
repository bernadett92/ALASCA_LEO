...
dir = ROUTINE_DIR()
if seeing4calib eq 2.5 then params_file='params_alasca_leo_daytime.pro' else params_file = 'params_alasca_leo_pyr.pro'
if seeing4calib eq 5.0 then params_file='params_alasca_leo_daytime_5.0.pro'
...
nframes = 10L
;if seeing4calib ge 2.0 then begin
;    params.pyramid.fov=8.0
;endif
