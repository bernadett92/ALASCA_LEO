pro alasca_leo_cloop, params, savedir, tn
  tic
  ...
  params = update_alasca_leo_params(params, objectDir=0., pwfs=0)
  ...
  prop_up_1550.add_layer_to_layer_list,  aber.out_layer
...
store.add, psf_sat.psf_center, name='psf_sat_center'
  ...
  ; saving
  tn = store.save_tracknum(dir=savedir, tn=tn, params=params, /nodlm, /nooldformat, /compress, /saveFloat)
